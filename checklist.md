...
* [x] Re-open `oiloctopus-utf8.txt` (if not still open).
...
* [x] Enter copyright clearance (get from DP [project page](https://www.pgdp.net/c/project.php?id=projectID655502d477e2f))
...
* [x] Credits line
  * Paste in from DP [project page](https://www.pgdp.net/c/project.php?id=projectID655502d477e2f)
